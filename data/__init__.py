...
from data.PASTIS24.dataloader import my_collate

DATASET_INFO = read_yaml(r"C:\Users\vipuser\Desktop\DeepSatModels-main\data\datasets.yaml")
    ...
    if 'test' in config['DATASETS']:
        ...
        if test_config['dataset'] == 'MTLCC':
            dataloaders['test'] = get_mtlcc_dataloader(
                ...
                batch_size=test_config['batch_size'], shuffle=False,
